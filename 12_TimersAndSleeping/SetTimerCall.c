 ...
 *  - ITIMER_VIRTUAL -> VIRTUAL CLOCK TIME, DECREMENTS ONLY WHEN THE PROCESS IS RUNNING (USER MODE), SENDS SIGVTALARM
 * - ITIMER_PROF -> (USER + KERNEL MODE BOTH )PROFILE CLOCK TIME, DECREMENTS ONLY WHEN THE PROCESS IS RUNNING AND DURING SYSCALL, SENDS SIGPROF
 */
